...
// that don't sign (e.g. CI checks); release signing is wired only when present.
...
android {
    ...
    signingConfigs {
        if (keystorePropsFile.exists()) {
            create("release") {
                // storeFile is resolved relative to the app module dir.
...
dependencies {
    ...
    implementation(libs.androidx.print) // PrintHelper for the post-save "Print" action on images
